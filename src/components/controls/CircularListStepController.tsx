...
// ─────────────────────────────────────────────────────────────────────────────
// src/components/controls/StepController.tsx  (Phase 2 upgrade)
//
// Redesigned with a visual progress bar, animated step description,
// and better keyboard hint integration.
// ─────────────────────────────────────────────────────────────────────────────
...
export function CircularListStepController() {
  ...
  const totalSteps       = useCircularLinkedListStore((s) => s.steps.length)
  const playbackSpeed    = useCircularLinkedListStore(selectors.playbackSpeed)
  const currentStep      = useCircularLinkedListStore(selectors.currentStep)

  const { play, pause, stepForward, stepBack, setPlaybackSpeed } =
    useCircularLinkedListStore(selectors.actions)
