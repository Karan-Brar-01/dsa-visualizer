...
export function DoublyListStepController() {
  ...
  const totalSteps       = useDoublyLinkedListStore((s) => s.steps.length)
  const playbackSpeed    = useDoublyLinkedListStore(selectors.playbackSpeed)
  const currentStep      = useDoublyLinkedListStore(selectors.currentStep)

  const { play, pause, stepForward, stepBack, setPlaybackSpeed } =
    useDoublyLinkedListStore(selectors.actions)
