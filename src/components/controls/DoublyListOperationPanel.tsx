...
const OPERATIONS: OpDef[] = [
  ...
  { mode: 'insertTail', label: 'Insert Tail', shortLabel: 'Tail', needsValue: true, needsIndex: false, group: 'insert', complexity: 'O(1)', accent: 'violet' },  { mode: 'deleteHead', label: 'Delete Head', shortLabel: 'Head', needsValue: false, needsIndex: false, group: 'delete', complexity: 'O(1)', accent: 'red' },
  { mode: 'deleteTail', label: 'Delete Tail', shortLabel: 'Tail', needsValue: false, needsIndex: false, group: 'delete', complexity: 'O(1)', accent: 'red' },]
...
export function DoublyListOperationPanel() {
  const id = useId()
  ...
  const actions   = useDoublyLinkedListStore(selectors.actions)
  const isPlaying = useDoublyLinkedListStore(selectors.isPlaying)
  const hasSteps  = useDoublyLinkedListStore((s) => s.steps.length > 0)
  const listSize  = useDoublyLinkedListStore(selectors.listSize)
